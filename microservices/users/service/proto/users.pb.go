...
var file_proto_users_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x1a, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x73,
...
var file_proto_users_proto_goTypes = []interface{}{
	...
	(*HelloReply)(nil),   // 1: users.HelloReply
}
var file_proto_users_proto_depIdxs = []int32{
	0, // 0: users.Greeter.SayHello:input_type -> users.HelloRequest
	1, // 1: users.Greeter.SayHello:output_type -> users.HelloReply
